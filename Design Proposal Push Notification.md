...
| **SPolling frequency** - 30-second intervals balance cost vs latency
  ...
  - *Future*: Dynamic polling frequency based on event activity periods) |
...
5. **Smart polling windows** - Only poll during typical event hours (e.g., 08:00-20:00 local time)
6. **Batch notifications** - Combine multiple changes for same user
